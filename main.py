...
def train_and_validate(valid_input, valid_target):
    net = STGCN(A_wave.shape[0],
                ...
                num_timesteps_input,
                num_timesteps_output, Ks, Kt, Cheb_Poly).to(device=device)
...
if __name__ == '__main__':
    ...
    # #  Adjacent Matrix, Normalized Data(num_nodes x num_feature{i.e. channel} x num_samples), mean and std_deviation
    ...
    # valid_input, valid_target = generate_dataset(val_original_data,
    #                                              num_timesteps_input=num_timesteps_input,
    #                                              num_timesteps_output=num_timesteps_output)
